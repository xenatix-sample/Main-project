GO
IF EXISTS(SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'Registration.fn_GetBenefitsAssistanceBenefitTypes'))
	BEGIN
	DROP FUNCTION Registration.fn_GetBenefitsAssistanceBenefitTypes
	END
