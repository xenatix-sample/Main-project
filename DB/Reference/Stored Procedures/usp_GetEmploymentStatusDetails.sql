-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	[usp_GetEmploymentStatusDetails]
-- Author:		Sumana Sangapu
-- Date:		07/22/2015
--
-- Purpose:		Gets the list of Employment Status lookup details
--
...
CREATE PROCEDURE [Reference].[usp_GetEmploymentStatusDetails]
...
BEGIN
	...
	BEGIN TRY	
		SELECT		EmploymentStatusID, EmploymentStatus 
		FROM		[Reference].[EmploymentStatus] 
		WHERE		IsActive = 1
