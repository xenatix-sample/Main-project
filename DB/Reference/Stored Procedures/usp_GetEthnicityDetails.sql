-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	[usp_GetEthnicityDetails]
-- Author:		Sumana Sangapu
-- Date:		07/22/2015
--
-- Purpose:		Gets the list of Ethnicity lookup details
--
...
CREATE PROCEDURE [Reference].[usp_GetEthnicityDetails]
