-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	[usp_GetReligionDetails]
-- Author:		Sumana Sangapu
-- Date:		07/22/2015
--
-- Purpose:		Gets the list of Religion lookup details
--
...
CREATE PROCEDURE [Reference].[usp_GetReligionDetails]
...
BEGIN
	...
	BEGIN TRY	
		SELECT		ReligionID, Religion 
		FROM		[Reference].[Religion] 
		WHERE		IsActive = 1
