 ...
 -----------------------------------------------------------------------------------------------------------------------
-- Procedure:	[usp_GetTreatmentTypeDetails]
-- Author:		Sumana Sangapu
-- Date:		07/22/2015
--
-- Purpose:		Gets the list of Treatment Type lookup  details
--
...
CREATE PROCEDURE [Reference].[usp_GetTreatmentTypeDetails]
...
BEGIN
	...
	BEGIN TRY	
		SELECT		TreatmentTypeID, TreatmentType 
		FROM		[Reference].[TreatmentType] 
		WHERE		IsActive = 1
		ORDER BY	TreatmentType  ASC
	END TRY
	BEGIN CATCH
