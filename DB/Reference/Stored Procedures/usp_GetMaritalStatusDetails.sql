-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	[usp_GetMaritalStatusDetails]
-- Author:		Sumana Sangapu
-- Date:		07/22/2015
--
-- Purpose:		Gets the list of Married Status lookup details
--
...
CREATE PROCEDURE [Reference].[usp_GetMaritalStatusDetails]
