-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	[usp_GetLanguageDetails]
-- Author:		Sumana Sangapu
-- Date:		07/22/2015
--
-- Purpose:		Gets the list of Language lookup details
--
...
CREATE PROCEDURE [Reference].[usp_GetLanguageDetails]
