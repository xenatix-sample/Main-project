-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	[usp_GetReferralSourceDetails]
-- Author:		Sumana Sangapu
-- Date:		07/22/2015
--
-- Purpose:		Gets the list of ReferralSource lookup details
--
...
CREATE PROCEDURE [Reference].[usp_GetReferralSourceDetails]
...
BEGIN
	...
	BEGIN TRY	
		SELECT		ReferralSourceID, ReferralSource
		FROM		[Reference].[ReferralSource] 
		WHERE		IsActive = 1
