-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeEligibility
-- Author:		John Crossen
-- Date:		08/03/2016
--
...
CREATE PROCEDURE [Core].usp_MergeEligibility
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'Eligibility', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'ECI', 'Eligibility', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
