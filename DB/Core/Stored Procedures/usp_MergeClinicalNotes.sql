-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeClinicalNotes
-- Author:		John Crossen
-- Date:		08/03/2016
--
...
CREATE PROCEDURE [Core].usp_MergeClinicalNotes
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'Notes', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'Clinical', 'Notes', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
