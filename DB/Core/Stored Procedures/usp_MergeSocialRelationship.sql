-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeSocialRelationship
-- Author:		John Crossen
-- Date:		08/03/2016
--
-- Purpose:		Main procedure for Client SocialRelationship
--
-- Notes:		N/A
--
-- Depends:		N/A
...
CREATE PROCEDURE [Core].usp_MergeSocialRelationship
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'SocialRelationship', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	WHERE
		SocialRelationshipID = @PKID;
		
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'Clinical', 'SocialRelationship', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
