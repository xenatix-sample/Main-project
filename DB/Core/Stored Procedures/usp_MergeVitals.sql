-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeVitals
-- Author:		John Crossen
-- Date:		08/03/2016
--
-- Purpose:		Main procedure for Client Virtals
--
-- Notes:		N/A
--
-- Depends:		N/A
...
CREATE PROCEDURE [Core].usp_MergeVitals
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'Vitals', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'Clinical', 'Vitals', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
