-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeChiefComplaint
-- Author:		John Crossen
-- Date:		08/03/2016
--
-- Purpose:		Main procedure for Client Chief Complaint
--
-- Notes:		N/A
--
-- Depends:		N/A
...
CREATE PROCEDURE [Core].usp_MergeChiefComplaint
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'ChiefComplaint', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	WHERE
		ChiefComplaintID = @PKID;
		
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'Clinical', 'ChiefComplaint', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
