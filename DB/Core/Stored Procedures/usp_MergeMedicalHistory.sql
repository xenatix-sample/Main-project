-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeMedicalHistory
-- Author:		John Crossen
-- Date:		08/03/2016
--
...
CREATE PROCEDURE [Core].usp_MergeMedicalHistory
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'MedicalHistory', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	WHERE
		MedicalHistoryID = @PKID;
		
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'Clinical', 'MedicalHistory', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
