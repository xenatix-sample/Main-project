-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeHPI
-- Author:		John Crossen
-- Date:		08/03/2016
--
-- Purpose:		Main procedure for Client HPI
--
-- Notes:		N/A
--
-- Depends:		N/A
...
CREATE PROCEDURE [Core].usp_MergeHPI
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'HPI', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'Clinical', 'HPI', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
