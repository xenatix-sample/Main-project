-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeContactAllergy
-- Author:		John Crossen
-- Date:		08/03/2016
--
-- Purpose:		Main procedure for Client ContactAllergy
--
-- Notes:		N/A
--
-- Depends:		N/A
...
CREATE PROCEDURE [Core].usp_MergeContactAllergy
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'ContactAllergy', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	WHERE
		ContactAllergyID = @PKID;
		
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'Clinical', 'ContactAllergy', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
