-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeIFSPParentGuardian
-- Author:		John Crossen
-- Date:		08/03/2016
--
...
CREATE PROCEDURE [Core].usp_MergeIFSPParentGuardian
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'ECI', 'IFSPParentGuardian', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;

	UPDATE ECI.IFSPParentGuardian
	SET ContactID = @ParentID,
		ModifiedOn = @ModifiedOn,
		ModifiedBy = @ModifiedBy,
		SystemModifiedOn = GETUTCDATE()
	WHERE
		ParentGuardianID = @PKID;
				
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'ECI', 'IFSPParentGuardian', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
