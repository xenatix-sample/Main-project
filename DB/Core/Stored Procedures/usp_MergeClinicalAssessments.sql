-----------------------------------------------------------------------------------------------------------------------
-- Procedure:	usp_MergeClinicalAssessments
-- Author:		John Crossen
-- Date:		08/03/2016
--
-- Purpose:		Main procedure for Client ClinicalAssessments
--
-- Notes:		N/A
--
-- Depends:		N/A
...
CREATE PROCEDURE [Core].usp_MergeClinicalAssessments
(
...
BEGIN
	...
	EXEC Core.usp_AddPreAuditLog @ProcName, 'Update', 'Clinical', 'ClinicalAssessments', @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
	...
	WHERE
		ClinicalAssessmentID = @PKID;
		
	EXEC Auditing.usp_AddPostAuditLog 'Update', 'Clinical', 'ClinicalAssessments', @AuditDetailID, @PKID, NULL, @ModifiedOn, @ModifiedBy, @ResultCode OUTPUT, @ResultMessage OUTPUT, @AuditDetailID OUTPUT;
