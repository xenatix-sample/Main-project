...
{
    /// <summary>
    /// Represents a AxisConfig
    /// </summary>
    public partial class AxisConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var appType = section.SelectSingleNode("Application");
            if (appType != null && appType.Attributes != null)
            {
                var attribute = appType.Attributes["Type"];
                if (attribute != null)
                    config.ApplicationType = attribute.Value;
            }
            return config;
        }
