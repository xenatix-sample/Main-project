...
namespace Axis.Model.Common.Assessment
{
    ...
    /// </summary>
    public class AssessmentQuestionModel : BaseEntity
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the options group name
        /// </summary>
        /// <value>
        ...
        /// </value>
        public List<AssessmentQuestionOptionModel> AssessmentQuestionOptions { get; set; }
    }
}