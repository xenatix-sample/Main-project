...
-- exec dbo.usp_SSISExtractICD10CMNeoplasms

CREATE PROCEDURE dbo.usp_SSISExtractICD10CMNeoplasms
AS
BEGIN
				--Extract Level1 Information
				INSERT INTO [dbo].[ICD10NeoplasmsCMLevel1Stage]
				SELECT
				...
				INSERT INTO [dbo].[ICD10NeoplasmsCMLevel2Stage]
				SELECT
					Parent.Elm.value('(title)[1]', 'varchar(100)') AS 'Title',
				...
				INSERT INTO [dbo].[ICD10NeoplasmsCMLevel3Stage]
				SELECT
					Parent.Elm.value('(title)[1]', 'varchar(100)') AS 'Title',
				...
				INSERT INTO [dbo].[ICD10NeoplasmsCMLevel4Stage]
				SELECT
					Parent.Elm.value('(title)[1]', 'varchar(100)') AS 'Title',
