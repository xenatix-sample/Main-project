...
using Axis.DataProvider.ECI.Shared;
...
{
    public class ECIDemographicDataProvider : ECIRegistrationBaseDataProvider<ECIContactDemographicsModel>, IECIDemographicDataProvider
    {
        #region Class Variables

        //private readonly IUnitOfWork _unitOfWork; //Unused Variables
        ...
        public Response<ECIContactDemographicsModel> GetContactDemographics(long contactID)
        {
            ...
            if (result.DataItems != null && result.DataItems.Any())
            {
                ...
                result.DataItems = new List<ECIContactDemographicsModel> { lstModel };
            }

            return result;
        }

        public override bool ContactOtherOperations(ECIContactDemographicsModel contact, Response<ECIContactDemographicsModel> spResults)
        {
        ...
        protected override List<SqlParameter> BuildContactAddUpdSpParams(ECIContactDemographicsModel contact)
        {
            var spParameters = new List<SqlParameter>
            {
                ...
                new SqlParameter("PreferredGenderID", DBNull.Value),
                ...
                new SqlParameter("DriverLicense", DBNull.Value),
                new SqlParameter("DriverLicenseStateID", DBNull.Value),
                new SqlParameter("IsPregnant", false),//always false for ECI
