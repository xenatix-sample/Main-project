...
namespace Axis.DataProvider.Security
{
    ...
    public interface ISecurityDataProvider
    {
        ...
        /// <returns></returns>
        Response<RoleModel> DeleteRole(long id, DateTime modifiedOn);
        ...
        /// <returns></returns>
        Response<RoleSecurityModel> GetUserRoleSecurity(int userId);
        ...
        Response<CredentialSecurityModel> GetUserCredentialSecurity(int userID);
