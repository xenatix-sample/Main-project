...
namespace Axis.DataEngine.Tests.Controllers.Registration.EmergencyContact
{
    [TestClass]
    public class EmergencyContactTest
    {
        private IEmergencyContactDataProvider emergencyContactDataProvider;
        ...
        {
            Mock<IEmergencyContactDataProvider> mock = new Mock<IEmergencyContactDataProvider>();
            emergencyContactDataProvider = mock.Object;

            emergencyContactController = new EmergencyContactController(emergencyContactDataProvider);
        ...
        public void GetEmergencyContacts_Failure()
        {
            ...
            //Assert
            Assert.IsTrue(emergencyContact.Count() == 0);
        }
        ...
        public void AddEmergencyContact_Success()
        {
            ...
            Assert.IsTrue(emergencyContact.Count() > 0, "Emergency contact could not be created.");
        }
        ...
        public void AddEmergencyContact_Failure()
        {
            ...
            //Assert
            Assert.IsTrue(response.Value.ResultCode != 0, "Emergency contact is created.");
        }
        ...
        public void UpdateEmergencyContact_Failure()
        {
            ...
            //Assert
            Assert.IsTrue(response.Value.ResultCode != 0, "Emergency contact is updated.");
        }
        ...
        public void DeleteEmergencyContact_Failure()
        {
            ...
            var response = deleteEmergencyContactResult as HttpResult<Response<EmergencyContactModel>>;
            var deleteEmergencyContact = response.Value;
            var count = deleteEmergencyContact.DataItems.Count;

            //Assert
            Assert.IsTrue(count > 0, "Emergency Contact could be deleted.");
        }
    }
}