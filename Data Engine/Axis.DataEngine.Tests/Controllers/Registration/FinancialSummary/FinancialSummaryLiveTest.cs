...
namespace Axis.DataEngine.Tests.Controllers.Registration.FinancialSummary
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class FinancialSummaryLiveTest
    {
        ...
        public void GetFinancialSummary_Failed()
        {
            ...
            // Assert
            Assert.IsTrue(response != null, "Response can't be null");
            Assert.IsTrue(response.DataItems.Count == 0, "Financial Summary exists for invalid data.");
        }
