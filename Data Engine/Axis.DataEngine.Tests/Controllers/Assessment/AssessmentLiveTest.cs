...
namespace Axis.DataEngine.Tests.Controllers.Assessment
{
    [TestClass]
    public class AssessmentLiveTest
    {
        ...
        public void GetAssessment_Success()
        {
            ...
            // Act
            var response = communicationManager.Get<Response<ScreeningNameModel>>(param, url);
        ...
        public void UpdateAssessmentResponseDetails_Success()
        {
            ...
            var assessmentOption = new List<AssessmentQuestionOptionModel>();
            assessmentOption.Add(new AssessmentQuestionOptionModel
            {
                Options = "None",
                OptionsGroupID = 4,
                OptionsGroupName = "None",
                OptionsID = 20,
                //ParentQuestionID = 1,
                QuestionID = 10,
                SortOrder = 3
            });
            var assessmentQuestion = new List<AssessmentQuestionModel>();
            assessmentQuestion.Add(new AssessmentQuestionModel
            {
                //ResponseDetailsID = 1,
                //ResponseID = 1,
                QuestionID = 10//,
