        ...
        public override void OnException(HttpActionExecutedContext filterContext)
        {
            ...
            if (ApplicationSettings.EnableLogging)
            {
                ...
                catch (Exception e)
                {
                    ...
                    logger.Error(e);
                    hostAddress = "NONE";// Need to change it 
                }
                ...
                if (ApplicationSettings.LoggingMode == (int)LoggingMode.DataBase)
                {
                    ...
                    var loggingDataProvider = System.Web.Http.GlobalConfiguration.Configuration.DependencyResolver.GetService(typeof(ILoggingDataProvider)) as ILoggingDataProvider;

                    loggingDataProvider.LogException(new ExceptionModel()
                    {
