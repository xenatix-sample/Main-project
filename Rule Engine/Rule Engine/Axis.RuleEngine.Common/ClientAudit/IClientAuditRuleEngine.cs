...
{
    public interface IClientAuditRuleEngine
    {
        /// <summary>
        ...
        /// <returns></returns>
        Response<ClientAuditModel> AddClientAudit(ClientAuditModel photo);
        Response<ScreenAuditModel> AddScreenAudit(ScreenAuditModel photo);
