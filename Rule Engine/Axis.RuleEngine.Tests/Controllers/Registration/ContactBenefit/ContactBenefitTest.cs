...
namespace Axis.RuleEngine.Tests.Controllers.Registration.ContactBenefit
{
    ...
    public class ContactBenefitTest
    {
        ...
        /// </summary>
        private IContactBenefitRuleEngine contactBenefitDataProvider;
        ...
        /// The mock
        /// </summary>
        private Mock<IContactBenefitRuleEngine> mock = null;
        ...
        {
            mock = new Mock<IContactBenefitRuleEngine>();
        ...
        public void GetPayorPlans_Success()
        {
            ...
            Response<PayorPlan> payorPlansAndAddressesExpectedResponse = new Response<PayorPlan>();
            payorPlansAndAddressesExpectedResponse.DataItems = payorPlansModelList;

            mock.Setup(r => r.GetPayorPlans(It.IsAny<int>()))
                .Returns(payorPlansAndAddressesExpectedResponse);
        ...
        public void GetGroupsAndAddressForPlan_Success()
        {
            ...
            List<PlanGroupAndAddressesModel> payorPlanGroupList = new List<PlanGroupAndAddressesModel> { groupAndAddressesModelSuccess };
