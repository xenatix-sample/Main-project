...
namespace Axis.RuleEngine.Tests.Controllers
{
    ...
    public class SecurityControllerTest
    {
        ...
        {
            //Act
            var addRole = new RoleModel { RoleID = 4, Name = "Physician" };
        ...
        {
            // Act
            var updateRole = new RoleModel { RoleID = 4, Name = "Phys" };
        ...
        public void DeleteRole_Success()
        {
            ...
            Assert.AreEqual(1, deletedRole.RowAffected, "Role could not be deleted.");
        }
        ...
        {
            SecurityController securityController = new SecurityController(securityRuleEngine);
