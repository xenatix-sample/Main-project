...
var textCarouselSetup = {

	pagination : ".text-carousel .owl-controls",
	slideshow : ".text-carousel .carouselouter",
	next : ".text-carousel .carouselouter .next",
	prev : ".text-carousel .carouselouter .prev",
	item : ".text-carousel .item",
	owlControls : ".text-carousel .owl-controls",

	sectionMenu : ".section-menu",

	init : function(){
		if($().owlCarousel){
			var owl = $(textCarouselSetup.slideshow).owlCarousel({
                    items : 4
			});
			// Custom Navigation Events
			$(textCarouselSetup.next).click(function(){
				owl.trigger('owl.next');
			});
			$(textCarouselSetup.prev).click(function(){
				owl.trigger('owl.prev');
			});
		}
	}
	...
	init : function(){
		...
		$('.parallax').each(function(){
		   ...
		   $(window).scroll(function() {
				...
				var yPos = -($window.scrollTop() / 1.3) + 600;
                if(yPos < 60) {
                    yPos = 60;
                }
