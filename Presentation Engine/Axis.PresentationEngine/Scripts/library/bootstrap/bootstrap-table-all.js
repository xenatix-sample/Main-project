...
!function ($) {
    ...
    var cellHeight = 37, // update css if changed
        cachedWidth = null,
        arrowAsc = 'data:image/png;base64,',
        arrowBoth = 'data:image/png;base64,',
        arrowDesc = 'data:image/png;base64,';
    ...
    BootstrapTable.DEFAULTS = {
        ...
        icons: {
            paginationSwitchDown: 'fa-chevron-circle-down fa-chevron-down',
            paginationSwitchUp: 'fa-chevron-circle-up fa-chevron-up',
            refresh: 'fa-refresh',
            toggle: 'fa-list',
            columns: 'fa-th'
        },
...
(function($) {
    ...
    var showSortModal = function(that) {
        if (!$("#sortModal").hasClass("modal")) {
            var sModal = '  <div class="modal fade" id="sortModal" tabindex="-1" role="dialog" aria-labelledby="sortModalLabel" aria-hidden="true" data-backdrop="static">';
            ...
            $sortModal.off('click', '.btn-primary').on('click', '.btn-primary', function() {
                ...
                if (results.length > 0) {
                    if ($alert.length === 0) {
                        $alert = '<div class="alert alert-danger" role="alert"><button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button><p><strong>' + that.options.formatDuplicateAlertTitle() + '</strong></p><p>' + that.options.formatDuplicateAlertDescription() + '</p></div>';
