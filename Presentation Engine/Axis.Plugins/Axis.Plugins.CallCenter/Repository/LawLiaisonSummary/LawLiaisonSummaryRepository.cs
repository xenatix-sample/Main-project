...
namespace Axis.Plugins.CallCenter.Repository.LawLiaisonSummary
{
    ...
    /// 
    /// </summary>
    /// <seealso cref="Axis.Plugins.CallCenter.Repository.LawLiaisonSummary.ILawLiaisonSummaryRepository" />
    public class LawLiaisonSummaryRepository : ILawLiaisonSummaryRepository
    {
        /// <summary>
        ...
        /// </summary>
        public LawLiaisonSummaryRepository()
        {
        ...
        public LawLiaisonSummaryRepository(string token)
        {
        ...
        /// <returns></returns>
        public async Task<Response<CallCenterSummaryViewModel>> GetLawLiaisonSummary(string searchStr, int userID, int searchTypeFilter, string callStatusID, int userIDFilter, bool isNormalView)
        {
        ...
        public Response<LawLiaisonIncidentModel> GetLawLiaisonIncident(long callCenterHeaderID)
        {
            ...
            var response = _communicationManager.Get<Response<LawLiaisonIncidentModel>>(requestId, apiUrl);
            return response;
        }
    }
}
